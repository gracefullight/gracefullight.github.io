...
- beside, nearby, next to
- across from
- in the center of ~
- the premises for ~: ~의 부지
- be sorrounded
- run through: ~로 흐르다
- along the river, on the banks of the river.
- to the east / west / south / north of
...
- 서론
  - The diagram illustrates how S V
  - It is clear that there are multiple stages in the process.
  - The process commences with N, and ends at N.
- 결론
  - Finally, when S V, this whole process repeats again.
...
- 시작
  ...
  - First, S V
  - To begin with, S V
  - The process commences with N
  - The process starts when S V
...
- 중간과정
  ...
  - At this point, S V
  - Subsequently, S V
  - The step after this is N
  - following this, S V
  - Simultaneously, S V
  - At the same time S V,
  - Once N has been done, S V
  - In addition to this step, S V
  - After the stage of N is completed, S V
- 종료
  - Finally, S V
  - Eventually, S V
  - Consequently, S V
  - Once the final stage has been completed, S V
