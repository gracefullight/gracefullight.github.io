---
title: 웹팩이 모듈을 불러오는 슈도코드
authors: me
tags: [javascript, nodejs, webpack]
date: 2018-03-25 22:32:45
---
...
배열에 다 때려넣고 호출해서 사용하는 방법이다
물론 내부는 더 복잡하다, 코드 스플리팅이 된다면 더더욱.

## 복잡한 내부

```js title="https://github.com/hg-pyun/minipack-kr/blob/master/src/minipack.js"
/**
...
[여기](https://github.com/hg-pyun/minipack-kr/blob/master/src/minipack.js)의 번역된 내용을 확인해보자.
